...
// Claude's '✳', Gemini's glyphs (✦ ⏲ ◇ ✋), Codely's ⏸️ / ✅, braille and
// quarter-circle spinners, and Claude's '. '/'* ' working/idle prefixes. Once
// the tab bar shows the provider icon, this leading glyph reads as a redundant
// second icon, so strip it from the displayed title. Scoped to titles we already
// know belong to an agent.
